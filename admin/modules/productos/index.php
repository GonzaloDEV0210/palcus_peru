              ...
              <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-5 py-3">
                  <div class="flex items-center gap-3">
                    <?php if ($p['imagen_url']): ?>
                    <img src="<?= e($p['imagen_url']) ?>" class="w-10 h-10 rounded-lg object-cover border border-gray-100" alt=""/>
                    <?php else: ?>
                ...
                <td class="px-5 py-3">
                  <div class="flex items-center justify-center gap-1">
                    ...
                    <form method="POST" action="eliminar.php" data-confirm="¿Estás seguro de eliminar este producto y todas sus variaciones?">
