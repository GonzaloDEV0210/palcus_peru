    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <div class="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p class="text-gray-400 text-sm">Historial de PDFs, facturas y reportes vinculados</p>
        </div>
        <a href="subir.php" class="bg-gray-900 hover:bg-gray-700 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-all shadow-sm flex items-center gap-2">
